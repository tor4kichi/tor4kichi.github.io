...
動画ビューアの上部、ウィンドウバーにもプレイヤー表示を制御するボタンがあります。左から「動画コンテンツのお気に入り切替」「プレイヤーの伸縮切替」「回転（時計回り」」「左右反転」「全画面表示」があります。
...
「回転切替」も「プレイヤーの伸縮」同様の選択切替方法です。デフォルトは「回転無し」、簡易切替対象は「90度」です。
...
複数選択したアイテムは、別フォルダへの移動したり、一括で削除したりできます。
